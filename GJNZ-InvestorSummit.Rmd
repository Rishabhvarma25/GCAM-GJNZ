...
prj <- addScenario(conn, proj = 'GJNZ_NZ70_LIFE.dat', scenario =  c('NZ70_LIFE'), queryFile = queryFileInput,warn.empty = T,clobber = T) # This command runs queries from queryFileInput against the database, extract the results for two scenario called and write the results to a file called "GJNZ.dat". 
...
prj <- loadProject(proj = "NZ70_LIFE.dat")
